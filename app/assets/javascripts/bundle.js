...
/* harmony import */ var _lib_game_view_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/game_view.js */ "./lib/game_view.js");
/* harmony import */ var _lib_game_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/game.js */ "./lib/game.js");
...
function locationPosition(height, width, placement) {
  ...
  var leftBound2 = 5,
      ...
      xPos2 = 5,
      yPos2 = 5;
  var randomDir = _lib_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].getRandomArbitrary(0, 2);
  ...
  xPos = _lib_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].getRandomArbitrary(leftBound, leftBound + SPAWN_SPACE / 4);
  yPos = _lib_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].getRandomArbitrary(upperBound, upperBound + SPAWN_SPACE / 4);
  var firstBase = [xPos, yPos];
  xPos2 = _lib_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].getRandomArbitrary(leftBound2, leftBound2 + SPAWN_SPACE / 4);
  yPos2 = _lib_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].getRandomArbitrary(upperBound2, upperBound2 + SPAWN_SPACE / 4);
...
function newGame() {
  ...
  while (numPlayers > 0) {
    var randomLocation = _lib_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].getRandomArbitrary(0, 4);
  ...
  game = new _lib_game_js__WEBPACK_IMPORTED_MODULE_2__["default"](Object.assign(selectedSettings, {
    difficulty: selectedDifficulty
  }));
  game.addStars(_lib_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].getRandomArbitrary(69, 420));
  ...
  gameView = new _lib_game_view_js__WEBPACK_IMPORTED_MODULE_1__["default"](game, context).start();
}
