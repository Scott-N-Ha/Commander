...
class Base {
  ...
  draw(context) {
    ...
    context.fillStyle = 'black';
    context.fillRect(this.x + (this.width / 2) - (progressBarDims.width / 2), this.y + Math.floor(this.width * .63), progressBarDims.width, progressBarDims.height)
    context.fillStyle = 'green';
    context.fillRect(this.x + (this.width / 2) - (progressBarDims.width / 2), this.y + Math.floor(this.width * .63), (progressBarDims.width * this.progress / 100), progressBarDims.height)
